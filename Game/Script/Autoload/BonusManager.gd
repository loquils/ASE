...
func GetDeltaDarkMatter():
	if InfosPartie.AtomesObtenusInThisReset.has("Hydrogene"):
		var quantiteeMatiereNoire = Big.divide(InfosPartie.AtomesObtenusInThisReset["Hydrogene"], CoefficientDivisionMatiereNoire)
