...
#Retourne l'apport d'un attribut d'un atome selon son niveau, 
func GetAttributRapportAvecNiveau():
	return Big.multiply(GetAttributCoefficientAvecAmeliorations(), Niveau)


#Retourne le coefficient d'un attribut avec les bonus appliqués.
#Prend en compte les bonus sur les coefficients et sur le global des coeffs d'un atome. 
func GetAttributCoefficientAvecAmeliorations():
	...
	return attributCoefficientApresBonus
