...
func _ready():
	...
	var newAtome2 = Atome.new("Helium", 0.3, 0)
	var ListeAttribsTest2 = [AttributAtome.new(newAtome, "Bleu", 0, 1.2, 1.07, 5), AttributAtome.new(newAtome, "Rouge", 0, 1.5, 1.10, 10)]
	newAtome2.setAttributs(ListeAttribsTest2)
